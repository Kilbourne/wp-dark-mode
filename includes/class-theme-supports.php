...
?>
	...
	public function enqueue_scripts() {
		if ($this->is_theme('Jannah')) {
			wp_enqueue_style('wp-dark-mode-jannah', WPDM_BASE_URL . 'assets/css/themes/jannah.css');
		}

		if ($this->is_theme('OceanWP')) {
			wp_enqueue_style('wp-dark-mode-salient', WPDM_BASE_URL . 'assets/css/themes/oceanwp.css');
		}

		if ($this->is_theme('Salient')) {
			wp_enqueue_style('wp-dark-mode-salient', WPDM_BASE_URL . 'assets/css/themes/salient.css');
		}

		if ($this->is_theme('Twenty Twenty')) {
			wp_enqueue_style('wp-dark-mode-twentytwenty', WPDM_BASE_URL . 'assets/css/themes/twentytwenty.css');
		}
