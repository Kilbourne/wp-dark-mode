...
if (!class_exists('WP_Dark_Mode_Settings')) {
	...
	class WP_Dark_Mode_Settings {
		...
		public function settings_fields() {
			...
			$sections = array(
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Display Settings</span>', 'wp-dark-mode'),
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Style Settings</span>', 'wp-dark-mode'),
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Gutenberg Block</span>', 'wp-dark-mode'),
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Elementor Widget</span>', 'wp-dark-mode'),
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Shortcodes</span>', 'wp-dark-mode'),
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Switch Widget</span>', 'wp-dark-mode'),
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Activate License</span>', 'wp-dark-mode'),
				...
				array(
					...
					'title' => sprintf(
						__('%s <span>Get Started</span>', 'wp-dark-mode'),
			...
			$fields = array(
				...
				'wp_dark_mode_general' => apply_filters('wp_dark_mode/general', array(
					...
					'enable_os_mode' => array(
						...
						'desc'    => __(
							...
							'wp-dark-mode'
						) . '<br><br><br> <img src="' . WPDM_BASE_URL . 'assets/images/os-theme.gif'
							. '" alt="">',
						'type'    => 'switcher',
					),
				...
				'wp_dark_mode_display'  => apply_filters('wp_dark_mode/display_settings', array(
					...
					'switch_style'      => array(
						...
						'type'    => 'image_choose',
						'options' => [
							'1' => WPDM_BASE_URL .  'assets/images/button-presets/1.svg',
							'2' => WPDM_BASE_URL .  'assets/images/button-presets/2.svg',
							'3' => WPDM_BASE_URL .  'assets/images/button-presets/3.svg',
							'4' => WPDM_BASE_URL .  'assets/images/button-presets/4.svg',
							'5' => WPDM_BASE_URL .  'assets/images/button-presets/5.svg',
							'6' => WPDM_BASE_URL .  'assets/images/button-presets/6.svg',
							'7' => WPDM_BASE_URL .  'assets/images/button-presets/7.svg',
						],
					),
					...
					'switcher_position' => array(
						...
						'desc'    => __(
							'Select the position of the floating dark mode switcher button on the frontend.',
							'wp-dark-mode'
						),
						'type'    => 'select',
						'options' => [
					...
					'switch_menus'   => array(
						'name'    => 'switch_menus',
						'default' => [get_called_class(), 'switch_menus'],
					...
					'exclude_pages' => array(
						'name'    => 'exclude_pages',
						'default' => [get_called_class(), 'exclude_pages'],
				...
				'wp_dark_mode_style'    => apply_filters('wp_dark_mode/style_settings', array(
					'color_preset'         => array(
						...
						'type'    => 'image_choose',
						'options' => [
							'0' => WPDM_BASE_URL .  'assets/images/color-presets/1.svg',
							'1' => WPDM_BASE_URL .  'assets/images/color-presets/2.svg',
							'2' => WPDM_BASE_URL .  'assets/images/color-presets/3.svg',
							'3' => WPDM_BASE_URL .  'assets/images/color-presets/4.svg',
							'4' => WPDM_BASE_URL .  'assets/images/color-presets/5.svg',
							'5' => WPDM_BASE_URL .  'assets/images/color-presets/6.svg',
							'6' => WPDM_BASE_URL .  'assets/images/color-presets/7.svg',
							'7' => WPDM_BASE_URL .  'assets/images/color-presets/8.svg',
							'8' => WPDM_BASE_URL .  'assets/images/color-presets/9.svg',
							'9' => WPDM_BASE_URL .  'assets/images/color-presets/10.svg',
							'10' => WPDM_BASE_URL .  'assets/images/color-presets/11.svg',
						],
					),
			...
			self::$settings_api = new \WPDM\includes\WPPOOL_Settings_API;
		...
		public static function switch_menus() {
		...
		public static function widget_doc() { ?>
			<div class="getting-started-wrap">
				<div class="getting-started-section">
					...
					<p><img src="<?php echo WPDM_BASE_URL . 'assets/images/switch-widget.png' ?>" alt=""></p>
			...
			<div class="wp-dark-mode-gutenberg-doc">
				...
				<ul class="doc-section">
					<li>
						...
						<img src="<?php echo WPDM_BASE_URL . 'assets/images/gutenberg/step-1.png' ?>" alt="step-1">
					</li>

					<li>
						<h3>Add "Dark Mode Switch" from "Text" category</h3>
						<img src="<?php echo WPDM_BASE_URL . 'assets/images/gutenberg/step-2.png' ?>" alt="step-2">
					</li>

					<li>
						<h3>Choose button style from block settings and you are done</h3>
						<img src="<?php echo WPDM_BASE_URL . 'assets/images/gutenberg/step-3.png' ?>" alt="step-2">
					</li>
				</ul>
			...
			<div class="wp-dark-mode-elementor-doc">
				...
				<ul class="doc-section">
					...
					<li>
						...
						<img src="<?php echo WPDM_BASE_URL . 'assets/images/elementor/step-1.png' ?>" alt="step-2">
					</li>

					<li>
						<h3>Choose button style from widget settings and you are done</h3>
						<img src="<?php echo WPDM_BASE_URL . 'assets/images/elementor/step-2.png' ?>" alt="step-2">
					</li>
				</ul>
