			...
			$fields = array(
				'wp_dark_mode_general' => apply_filters( 'wp_dark_mode/general_settings', array(
					...
					'enable_frontend'   => array(
						...
						'type'    => 'switcher',
						'desc'    => sprintf( __( 'Enable the dark mode for the users on the frontend. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
					),
					'enable_backend'    => array(
						...
						'desc'    => sprintf( __( 'Enable the dark mode for the admins on the backend. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'switcher',
					),
					'match_os_mode'     => array(
						...
						'desc'    => sprintf( __( 'Automatically shows Darkmode if the OS prefered theme is dark. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'switcher',
					),
					'time_based_mode'   => array(
						...
						'desc'    => sprintf( __( 'Automatically turn on the dark mode between a given time range. %s',
							'wp-dark-mode' ), wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'switcher',
					),
					'start_at'          => array(
						'name'    => 'start_at',
						...
						'desc'    => sprintf( __( 'Time to start Dark mode. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'select',
						'options' => $time_range,
					),
					'end_at'            => array(
						...
						'desc'    => sprintf( __( 'Time to end Dark mode. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'select',
						'options' => $time_range,
					),
					'remember_darkmode' => array(
						...
						'desc'    => sprintf( __( 'Check ON to remember the darkmode status, if darkmode mode status "ON" will start automatically when visiting website again. %s',
							'wp-dark-mode' ), wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'switcher',
					),
				) ),
				...
				'wp_dark_mode_display' => apply_filters( 'wp_dark_mode/display_settings', array(
					'show_switcher'     => array(
						...
						'desc'    => sprintf( __( 'Show the floating dark mode switcher button on the frontend for the users. %s',
							'wp-dark-mode' ), wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'switcher',
					),
					'switch_style'      => array(
						...
						'desc'    => sprintf( __( 'Select the switcher button style for the frontend. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'image_choose',
						'options' => [
					...
					'switcher_position' => array(
						...
						'desc'    => sprintf( __( 'Select the position of the floating dark mode switcher button on the frontend. %s',
							'wp-dark-mode' ), wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'select',
						'options' => [
					...
					'show_above_post'   => array(
						...
						'desc'    => sprintf( __( 'Show the dark mode switcher button above of all the post. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'switcher',
					),
					'show_above_page'   => array(
						...
						'desc'    => sprintf( __( 'Show the dark mode switcher button above of all the pages. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'switcher',
					),
				) ),
				...
				'wp_dark_mode_style'   => apply_filters( 'wp_dark_mode/style_settings', array(
					'color_preset'         => array(
						...
						'desc'    => sprintf( __( 'Select the predefined darkmode background, text and link preset color. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'image_choose',
						'options' => [
					...
					'darkmode_bg_color'    => array(
						...
						'desc'    => sprintf( __( 'Select the background color when the dark mode is on. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'color',
					),
					'darkmode_text_color'  => array(
						...
						'desc'    => sprintf( __( 'Select the text color when the dark mode is on. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'color',
					),
					'darkmode_links_color' => array(
						...
						'desc'    => sprintf( __( 'Select the links color when the dark mode is on. %s', 'wp-dark-mode' ),
							wp_dark_mode()->is_pro_active() ? '' : $pro_message ),
						'type'    => 'color',
					),
				) ),
