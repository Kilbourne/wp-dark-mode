		...
		public function _register_controls() {
			...
			$this->add_control('switch_style', [
				...
				'options'     => [
					'1' => [
						'title'       => 'Style 1',
						'image_small' => WPDM_BASE_URL . 'assets/images/button-presets/1.svg',
						'image_large' => '',
					],
					'2' => [
						'title'       => 'Style 2',
						'image_small' => WPDM_BASE_URL . 'assets/images/button-presets/2.svg',
						'image_large' => '',
					],
					'3' => [
						'title'       => 'Style 3',
						'image_small' => WPDM_BASE_URL . 'assets/images/button-presets/3.svg',
						'image_large' => '',
					],
					'4' => [
						'title'       => 'Style 4',
						'image_small' => WPDM_BASE_URL . 'assets/images/button-presets/4.svg',
						'image_large' => '',
					],
					'5' => [
						'title'       => 'Style 5',
						'image_small' => WPDM_BASE_URL . 'assets/images/button-presets/5.svg',
						'image_large' => '',
					],
					'6' => [
						'title'       => 'Style 6',
						'image_small' => WPDM_BASE_URL . 'assets/images/button-presets/6.svg',
						'image_large' => '',
					],
					'7' => [
						'title'       => 'Style 7',
						'image_small' => WPDM_BASE_URL . 'assets/images/button-presets/7.svg',
						'image_large' => '',
					],
				],
				'default'     => '1',
