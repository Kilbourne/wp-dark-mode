...
<div class="wp-dark-mode-switcher wp-dark-mode-ignore  style-7 <?php echo $is_floating ? "floating $position" : ''; ?>">
    <label for="wp-dark-mode-switch">
        <div class="modes">
            <img class="light" src="<?php echo wp_dark_mode()->plugin_url( 'assets/images/btn-7/light.png' ); ?>">
            <img class="dark" src="<?php echo wp_dark_mode()->plugin_url( 'assets/images/btn-7/dark.png' ); ?>">
        </div>
    </label>
</div>